/* PrismJS 1.26.0
https://prismjs.com/download.html?#themes=prism-okaidia&languages=markup+css+clike+javascript+css-extras+json+markup-templating+php+scss+typescript&plugins=remove-initial-line-feed+inline-color */
